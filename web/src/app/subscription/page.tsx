            ...
            <div className="grid gap-4 lg:grid-cols-3">
              ...
              {plans.map((plan) => {
                ...
                return (
                  <div
                    key={plan.id}
                    className={`flex h-full flex-col justify-between rounded-2xl border border-slate-800/80 bg-slate-900/40 p-5 transition-all duration-150 ${
...
function TrialCard({
  ...
  return (
    <div className="flex h-full flex-col justify-between rounded-2xl border border-slate-800/80 bg-slate-900/50 p-5">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-lg font-semibold text-white">Free trial</p>
          <p className="mt-1 text-xs font-semibold uppercase tracking-wide text-emerald-300">Start fast</p>
        </div>
      </div>
